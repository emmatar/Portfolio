    ...
    <>
      <Container className="single-proj-cont">
        <Col className="single-proj-text">
          ...
          <p className="app-description">
            A weather application that displays the forecast AND weather or not
            to wear a sweater or not (im so sorry).
          </p>
        </Col>
      ...
      <Container className="single-proj-cont">
        <Col className="single-proj-text">
          ...
          <p className="app-description">
            ...
            some Javascript Basics? Well, if you are, you&apos;re exactly where
            you need to be. The Code quiz is a timed quiz that will dock the
            time to complete the quiz, if you answer incorrectly! slow but
            intense music plays
          </p>
        </Col>
        <Col className="single-proj-img d-flex align-items-center">
      ...
      <Container className="single-proj-cont">
        <Col className="single-proj-text">
          ...
          <p className="app-description">
            ...
            professionals to manage patient health by tracking and viewing their
            patients logs. As well as, the ability to schedule and create
            appointments via npm calendar package. Last, but not least, the user
            can also add new patients and add personalized notes.
          </p>
        </Col>
        <Col className="single-proj-img d-flex align-items-center">
          <a
      ...
      <Container className="single-proj-cont">
        <Col className="single-proj-text">
          ...
          <p className="app-description">
            ...
            has passed, is within the current hour, or is still lingering in the
            near future!
          </p>
        </Col>
        <Col className="single-proj-img d-flex align-items-center">
      ...
      <Container className="single-proj-cont">
        <Col className="single-proj-text">
          <h4 className="app-title">
            Note Taker
            <a href="https://github.com/emmatar/Note-Taker.git" target="blank">
              <img className="github-icon" src={gitHubIcon} alt="github-icon" />
            </a>
          </h4>
          <p className="app-description">
            A fun place where you can keep track of your LIFE for tree-fiddy, jk
            its free! Note Taker&apos;s mission is to create a place where users
            can write down their thoughts so that they can keep track of the
            important events and tasks throughout this worlds&apos; busy
            schedule.
          </p>
        </Col>
        <Col className="single-proj-img d-flex align-items-center">
